with cartentries as (
    select  
        ...
        --, cast(createdTS as datetime) as TS_produto_adicionado -- SELECT * FROM `basket-440419.cantu_raw.tb_cartentries` where createdTS =  "1.00000000"  
        --, cast(modifiedTS as datetime) as TS_produto_modificado -- SELECT * FROM `basket-440419.cantu_raw.tb_cartentries` where modifiedTS =  "1021.5"
        , cast(TypePkString as int) as id_tipo_produto
